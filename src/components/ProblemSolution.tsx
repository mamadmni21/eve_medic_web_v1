...
export const ProblemSolution = () => {
  ...
  const localizedContent = {
    ...
    ms: {
      ...
      probNum: "01",
      probTitle: "Menyelesaikan Krisis Data Klinikal Terfragmen",
      probDesc: "Penjagaan kesihatan ibu bersalin pada masa ini dicirikan oleh kedudukan data terpisah (silo). Sejarah pesakit terperangkap dalam institusi individu, membawa kepada kitaran diagnostik berlebihan dan peningkatan risiko klinikal.",
      solNum: "02",
      solTitle: "EVE: Tulang Belakang Data Longitudinal",
      solDesc: "EVE menyeragamkan pengambilan data klinikal, mewujudkan rekod bersatu yang mengikuti pesakit di seluruh klinik, hospital, dan makmal.",
    ...
    id: {
      ...
      probNum: "01",
      probTitle: "Menyelesaikan Krisis Data Klinis Terfragmentasi",
      probDesc: "Layanan kesehatan ibu saat ini dicirikan oleh sekat-sekat informasi terpisah (silo). Riwayat pasien terperangkap dalam masing-masing institusi, menyebabkan siklus diagnostik yang berulang dan meningkatnya risiko klinis secara signifikan.",
      solNum: "02",
