...
export const ProblemSolution = () => {
  ...
  return (
    <section className="relative py-20 px-6 md:px-12 bg-black overflow-hidden border-t border-white/5">
      {/* Ambient #191863 Top-Left Gradient */}
      <div className="absolute top-0 left-0 w-[600px] h-[600px] bg-[#191863] opacity-45 blur-[150px] rounded-full pointer-events-none -translate-x-1/3 -translate-y-1/3 z-0" />
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-stretch relative">
          ...
          >
            ...
            <div>
              ...
              <div className="flex items-center justify-between mb-8">
                <span className="text-5xl font-black text-white group-hover:text-red-400 transition-all font-mono">
                  {content.probNum}
                </span>
          ...
          >
            ...
            <div>
              {/* Card Header row */}
              <div className="flex items-center justify-between mb-8">
                <span className="text-5xl font-black text-white group-hover:text-indigo-300 transition-all font-mono">
                  {content.solNum}
                </span>
