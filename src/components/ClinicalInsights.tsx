...
export const ClinicalInsights = () => {
  ...
  const translations = {
    ...
    ms: {
      ...
      longitudinalDesc1: "mengurangkan risiko dengan ketara untuk ibu dan bayi melalui rekod yang bersatu dan berterusan.",
      longitudinalDesc2: "membuka kecerdasan berskala dan pandangan kesihatan menyeluruh sistem, meletakkan platform sebagai PaaS berkuasa yang penting untuk memodenkan ekosistem penjagaan ibu dan kesuburan",
    ...
    id: {
      ...
      longitudinalDesc1: "secara signifikan memitigasi risiko bagi ibu dan bayi melalui rekam medis yang terpadu dan persisten.",
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="mt-8 pt-6 border-t border-white/5 flex items-center justify-between">
                  <span className="text-xs font-mono font-bold text-gray-500 uppercase tracking-widest">Calculated EVE Metric</span>
